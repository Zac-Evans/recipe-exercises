function marinaraSauce(cookName) {
    ...
    console.log("-Add " + oneFourth + " cup of water, " + two + " cans of crushed tomatoes, and sald and season with black pepper to taste.");
    ...
    console.log("- Stir in " + oneFourth + " of a cup roughly chopped fresh basil, salt and pepper as needed.");
}
